...
RESET: 
	...
	LDI COREB, 0b00110000				; Initialize CONTROL REGISTER B
...
CHECK_STOP_BUTTON:						; If(PIND:7 == 0) Then STOP Button was 
	SBIC PIND, 7						; pressed => ALARM. Else continue execution
	JMP ALARM
...
SET_Y2:									;	TURN OFF LED 5
	SBR COREA, 1						; ELSE
	CBR COREA, 2						;	Continue Execution
	CBI PORTB, 3
	SBI PORTB, 5
