...
WAIT_ON_START_BUTTON:
	SBIC PIND, 0							;START WHEN SW0 IS PRESSED
...
CHECK_IF_STOP_PRESSED:
	SBIS PIND, 7							;IF SW7 IS PRESSED JUMP ON ALARM
	JMP ALARM

CHECK_IF_SW1_PRESSED:
	SBIC PIND, 1							;IF SW1 IS PRESSED
...
SECOND_LOOP:	
	...
	SBIC PIND, 6							;WAIT ACKNOWLEDGEMENT BUTTON SW6 TO BE PRESSED
...
LOOP:
	CPI R19, 255	;!!! WRONG 427 IS THE RIGHT FOR 7 SECS
	BRLT LOOP
...
SET_A1:
	SBR COREA, 3
	SBI PORTB, 1							;TURN ON LED 1
	JMP READ_Q1
CLEAR_A1:
	CBR COREA, 3
	CBI PORTB, 1							;TURN OFF LED 1

;TODO READ Q1, Q2
READ_Q1:
	SBIS PIND, 4							;IF SW4 == 1
	JMP Q1_PRESSED							;THEN 
Q1_NOT_PRESSED:								;	SET Q1 = 0
	SBR COREB, 5							;ELSE
	JMP READ_Q2								;	SET Q1 = 1
Q1_PRESSED:									
	CBR COREB, 5

READ_Q2:
	SBIS PIND, 5							;IF SW5 == 1
	JMP Q2_PRESSED							;THEN
Q2_NOT_PRESSED:								;	SET Q2 = 0
	SBR COREB, 4							;ELSE
	JMP END_OF_TIMER2_OVF					;	SET Q2 = 1
Q2_PRESSED:
	CBR COREB, 4
